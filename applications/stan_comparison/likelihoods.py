...
@njit
def sample_static_diffusion_process(theta, num_steps=100, beta=0.5, dt=0.001, s=1.0, max_iter=1e5):
    ...
    num_steps : int, optional, default: 400
        The number of time steps to take for the static diffusion process.
