...
class OneDimensionalAmortizer(tf.keras.Model):
    ...
    def __init__(self, hidden_units_local=128, hidden_units_global=128, summary_net=None):
        ...
        if summary_net is None: 
            raise NotImplementedError('You need a summary netowork for this toy example!')
    ...
    def compute_loss(self, input_dict, **kwargs):
        ...
        nll_global = tf.reduce_mean(-global_dist.log_prob(input_dict['hyper_parameters']))
